    ...
    <main className="mx-auto max-w-3xl px-4 py-8">
      <div className="border border-gray-300 bg-white">
        <div className="border-b border-gray-300 bg-gray-100 px-4 py-3">
          <h1 className="text-lg font-bold text-gray-900">ログイン / 新規登録</h1>
          <p className="mt-1 text-sm leading-relaxed text-gray-600">
            Googleアカウントで無料で始められます。ログインすると、投稿者ページの作成、投稿履歴の確認、投稿者ランキングへの参加ができます。
          </p>
          <p className="mt-1 text-sm leading-relaxed text-gray-600">
            ログインしなくても、これまで通り匿名でスレ立て・コメント投稿できます。
          </p>
        </div>
        ...
        <div className="grid gap-6 p-4 md:grid-cols-[1fr_260px]">
          ...
          <aside className="rounded border border-blue-200 bg-blue-50 p-3 text-xs leading-relaxed text-blue-900">
            ...
            <p>
              ログインしなくても、これまで通り匿名でスレ立て・コメント投稿できます。登録ユーザー機能は、投稿者ページやランキングに参加したい方向けの追加機能です。
            </p>
