      ...
      <div className="bg-white border border-gray-300 p-5 leading-relaxed text-gray-800">
        ...
        <div className="space-y-5 text-sm text-gray-800">
          ...
          <section>
            ...
            <p>
              当サイトは、デュエル・マスターズに関する情報共有・交流・デッキ作成・編集・プレイ支援機能を提供するWebサービスです。
              当サイトはファンコンテンツ・ポリシーに沿った非公式のファンサービスです。
              株式会社タカラトミーおよびウィザーズ・オブ・ザ・コースト社の認可・許諾は得ておらず、各権利者とは一切関係ありません。
              題材の一部に各権利者の財産を含み、カード画像・名称等に関する権利は各権利者に帰属します。©Wizards of the Coast LLC.
