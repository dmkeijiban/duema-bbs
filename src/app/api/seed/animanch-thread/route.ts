...
const OFFICIAL_CARD_IMAGES: Record<string, { imageUrl: string; cardUrl: string }> = {
  '維新の超人': {
    imageUrl: 'https://dm.takaratomy.co.jp/wp-content/card/cardimage/dm29-019.jpg',
    cardUrl: 'https://dm.takaratomy.co.jp/card/detail?id=dm29-019',
  },
  '轟轟轟ブランド': {
...
function templateGenerate(source: SourceThread): GeneratedThread {
  ...
  if (/ネタだと思ってた|2ランデス|ドスファング|ガチで強かった|毎ターン.*マナ/.test(text)) {
    return {
      title: 'ネタだと思ってたカード、実はちゃんと強かったやつ？',
      body: [
        'ネタ寄りのカードだと思ってたけど、もしかして普通に強かったやつ？',
        '',
        '3ターン目くらいに出せるなら2ランデスって今見てもかなり重いし、毎ターン殴られるだけでマナを削られるのは普通にきつそう',
        '',
        '重いから笑って見てたけど、昔のゲームスピードなら着地しても間に合う場面は多かったのかな',
        '',
        'ドスファングを引けない時の穴埋めとして入るなら分かる気もする',
        'ただ4枚入れるほどかと言われると、そこはちょっと悩む',
      ].join('\n'),
      comments: [
        ...
        'ドスファング引けない時の保険として入るなら分かる。4枚はさすがに多そうだけど',
      ],
