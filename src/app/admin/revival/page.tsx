  ...
  return (
    <div className="max-w-screen-lg mx-auto px-3 py-4 text-sm">
      ...
      <div className="mb-4 border border-blue-200 bg-blue-50 p-3">
        <h2 className="font-bold text-blue-800 text-xs mb-1.5">📋 リバイバルコメント生成手順</h2>
        <ol className="text-[11px] text-blue-700 space-y-0.5 list-decimal list-inside">
          <li>以下の候補スレを確認し、「保護」または「アーカイブ」で対象を絞り込む</li>
          <li>
            ターミナルで生成スクリプトを実行:
            <code className="ml-1 bg-blue-100 px-1 py-0.5 font-mono">node scripts/generate-empty-thread-revival.mjs</code>
          </li>
          <li>
            <code className="bg-blue-100 px-1 py-0.5 font-mono">revival-preview-YYYY-MM-DD/preview.md</code> を確認・承認
          </li>
          <li>
            承認後に INSERT:
            <code className="ml-1 bg-blue-100 px-1 py-0.5 font-mono">node scripts/insert-approved-revival-comments.mjs --file revival-preview-YYYY-MM-DD/comments.json</code>
          </li>
