...
export async function TypefullyQueueWidget() {
  ...
  return (
    <details className="mb-4" open>
      <summary className="flex items-center justify-between pb-1 border-b border-gray-200 cursor-pointer [list-style:none] [&::-webkit-details-marker]:hidden select-none">
