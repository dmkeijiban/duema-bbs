...
export default function UsageStatsSection({ stats, errorMessage }: Props) {
  ...
  return <section className="mt-4 rounded-xl border bg-slate-100/60 p-4">
    ...
    </Group> : <div className="mt-4 rounded-lg border border-amber-200 bg-amber-50 p-3"><h3 className="text-sm font-black text-amber-900">アクセス状況</h3><p className="mt-1 text-xs text-amber-800">PV計測migrationの適用後から新規計測を開始します。計測開始前のアクセスは含みません。</p></div>}
    <Group title="回答状況">
