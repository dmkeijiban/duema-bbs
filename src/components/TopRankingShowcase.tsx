...
function ProfileIconLink({ user }: { user: ProfileShowcaseUser }) {
  return (
    <Link
      ...
      prefetch={false}
      className="relative flex h-14 min-w-0 items-center justify-center overflow-hidden bg-white transition-colors hover:bg-gray-50 md:h-24"
    >
...
export function TopRankingShowcaseSkeleton() {
  return (
    <div className="mb-2 border border-gray-300 bg-white animate-pulse">
      ...
      <div className="grid grid-cols-5 gap-px bg-gray-200 md:grid-cols-10">
        {[...Array(10)].map((_, i) => (
          <div key={i} className="relative flex h-14 min-w-0 items-center justify-center overflow-hidden bg-white md:h-24">
