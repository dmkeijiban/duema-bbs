  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dm18-019'),
        officialUrl: officialPage('dm18-019'),
      },
      {
        name: '《予言者ローラン》',
        initial: '殿堂入り → 無制限',
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dm24-s04'),
        officialUrl: officialPage('dm24-s04'),
      },
      {
        name: '《アクア・ハルカス》',
        initial: '殿堂入り → 無制限',
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dm01-023'),
        officialUrl: officialPage('dm01-023'),
      },
      {
        name: '《凶星王ダーク・ヒドラ》',
        initial: 'プレミアム殿堂 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り', 'プレミアム殿堂', '殿堂入り', '無制限'],
        imageUrl: officialImage('dm05-006'),
        officialUrl: officialPage('dm05-006'),
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り', 'プレミアム殿堂'],
        imageUrl: officialImage('dm11-049'),
        officialUrl: officialPage('dm11-049'),
      },
      {
        name: '《鎧亜戦隊ディス・マジシャン》',
        initial: '殿堂入り → プレミアム殿堂',
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dm20-009'),
        officialUrl: officialPage('dm20-009'),
      },
      {
        name: '《奇跡の精霊ミルザム》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り', 'プレミアム殿堂'],
        imageUrl: officialImage('dm27-s01'),
        officialUrl: officialPage('dm27-s01'),
      },
      {
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmr13-v02a'),
        officialUrl: officialPage('dmr13-v02'),
        images: [
          { src: officialImage('dmr13-v02a'), name: '邪帝斧 ボアロアックス' },
          { src: officialImage('dmr13-v02b'), name: '邪帝遺跡 ボアロパゴス' },
        ],
      },
      {
        name: '《フェアリー・ギフト》',
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dm14-038'),
        officialUrl: officialPage('dm14-038'),
      },
      {
        name: '《フォース・アゲイン》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り', 'プレミアム殿堂'],
        imageUrl: officialImage('dm27-039'),
        officialUrl: officialPage('dm27-039'),
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        description: '',
        history: ['無制限', 'プレミアム殿堂'],
        imageUrl: officialImage('dm36-029'),
        officialUrl: officialPage('dm36-029'),
      },
      {
        name: '《奇跡の精霊ミルザム》',
        initial: '殿堂入り → プレミアム殿堂',
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dmr21-019'),
        officialUrl: officialPage('dmr21-019'),
      },
      {
        name: '《蛇手の親分ゴエモンキー！》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dm35-037'),
        officialUrl: officialPage('dm35-037'),
      },
      {
        name: '《常勝ディス・オプティマス》',
        initial: '無制限 → 殿堂入り',
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmr18-014'),
        officialUrl: officialPage('dmr18-014'),
      },
      {
        name: '《メガ・マナロック・ドラゴン》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmr17-s04'),
        officialUrl: officialPage('dmr17-s04'),
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmr17-050'),
        officialUrl: officialPage('dmr17-050'),
      },
      {
        name: '《S級原始 サンマッド》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmr19-s08'),
        officialUrl: officialPage('dmr19-s08'),
      },
      {
        name: '《スクランブル・チェンジ》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dmr21-018'),
        officialUrl: officialPage('dmr21-018'),
      },
      {
        name: '《大勇者「鎖風車」》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dm14-014'),
        officialUrl: officialPage('dm14-014'),
      },
      {
        name: '《魔龍バベルギヌス》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dm22-013'),
        officialUrl: officialPage('dm22-013'),
      },
      {
        name: '《目的不明の作戦》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmrp22-020'),
        officialUrl: officialPage('dmrp22-020'),
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dm32-009'),
        officialUrl: officialPage('dm32-009'),
      },
      {
        name: '《龍仙ロマネスク》',
        initial: '殿堂入り → 無制限',
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', 'プレミアム殿堂'],
        imageUrl: officialImage('dmr23-050'),
        officialUrl: officialPage('dmr23-050'),
      },
      {
        name: '《裏切りの魔狼月下城》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り', 'プレミアム殿堂'],
        imageUrl: officialImage('dmr21-032'),
        officialUrl: officialPage('dmr21-032'),
      },
      {
        name: '《超次元ガロウズ・ホール》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dmr01-023'),
        officialUrl: officialPage('dmr01-023'),
      },
      {
        name: '《破界秘伝ナッシング・ゼロ》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dmr21-055'),
        officialUrl: officialPage('dmr21-055'),
      },
      {
        name: '《真・龍覇 ヘブンズロージア》',
        initial: '無制限 → 殿堂入り',
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmr17-021'),
        officialUrl: officialPage('dmr17-021'),
      },
      {
        name: '《音精 ラフルル》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り', 'プレミアム殿堂'],
        imageUrl: officialImage('dmr21-014'),
        officialUrl: officialPage('dmr21-014'),
      },
      {
        name: '《龍素知新》',
        initial: '無制限 → 殿堂入り',
    ...
    cards: [
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dmr05-006'),
        officialUrl: officialPage('dmr05-006'),
      },
      {
        name: '《次元の霊峰》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dm10-103'),
        officialUrl: officialPage('dm10-103'),
      },
      {
        name: '《ゼロの裏技ニヤリー・ゲット》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dmr19-051'),
        officialUrl: officialPage('dmr19-051'),
      },
      {
        name: '《プラチナ・ワルスラS》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dmr23-s04'),
        officialUrl: officialPage('dmr23-s04'),
      },
    ],
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dm29-s05'),
        officialUrl: officialPage('dm29-s05'),
      },
      {
        name: '《ミステリー・キューブ》',
        initial: '殿堂入り → 無制限',
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmr21-l01'),
        officialUrl: officialPage('dmr21-l01'),
      },
      {
        name: '《ドリル・スコール》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dm06-097'),
        officialUrl: officialPage('dm06-097'),
      },
      {
        name: '《黒神龍ブライゼナーガ》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dm10-014'),
        officialUrl: officialPage('dm10-014'),
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmr02-007'),
        officialUrl: officialPage('dmr02-007'),
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り', 'プレミアム殿堂'],
        imageUrl: officialImage('dmr02-v02b'),
        officialUrl: officialPage('dmr02-v02'),
        images: [
          { src: officialImage('dmr02-v02b'), name: '雷獣ヴォルグ・ティーガー' },
        ],
      },
    ],
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dm10-030'),
        officialUrl: officialPage('dm10-030'),
      },
      {
        name: '《“轟轟轟”ブランド》',
        initial: '無制限 → 殿堂入り',
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmrp11-m01'),
        officialUrl: officialPage('dmrp11-m01'),
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り', 'プレミアム殿堂'],
        imageUrl: officialImage('dmr21-013'),
        officialUrl: officialPage('dmr21-013'),
      },
      {
        name: '《Dの牢閣 メメント守神宮》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmr22-012'),
        officialUrl: officialPage('dmr22-012'),
      },
      {
        name: '《禁断機関 VV-8》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmr21-s02'),
        officialUrl: officialPage('dmr21-s02'),
      },
      {
        name: '《バロン・ゴーヤマ》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dm29-035'),
        officialUrl: officialPage('dm29-035'),
      },
      {
        name: '《侵革目 パラスラプト》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmr17-009'),
        officialUrl: officialPage('dmr17-009'),
      },
      {
        name: '《勝利のアパッチ・ウララー》',
        initial: '殿堂入り → 無制限',
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dm31-012'),
        officialUrl: officialPage('dm31-012'),
      },
      {
        name: '《希望の絆 鬼修羅》',
        initial: '殿堂入り → 無制限',
    ...
    cards: [
      {
        ...
        description: '',
        history: ['プレミアム殿堂'],
        imageUrl: officialImage('dmex08-298'),
        officialUrl: officialPage('dmex08-298'),
      },
    ],
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmrp09-m02'),
        officialUrl: officialPage('dmrp09-m02'),
      },
      {
        name: '《腐敗勇騎ドルマークス》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dm10-056'),
        officialUrl: officialPage('dm10-056'),
      },
      {
        name: '《熱き侵略 レッドゾーンZ》',
        initial: '無制限 → 殿堂入り',
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dm10-061'),
        officialUrl: officialPage('dm10-061'),
      },
      {
        name: '《魂と記憶の盾》',
        initial: '殿堂入り → 無制限',
        description: '',
        history: ['無制限', '殿堂入り', '無制限'],
        imageUrl: officialImage('dm11-011'),
        officialUrl: officialPage('dm11-011'),
      },
      {
        name: '《ガチンコ・ルーレット》',
        initial: '殿堂入り → 無制限',
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmrp12-020'),
        officialUrl: officialPage('dmrp12-020'),
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dmrp11-s07'),
        officialUrl: officialPage('dmrp11-s07'),
      },
      {
        name: '《生命と大地と轟破の決断》',
        initial: '無制限 → 殿堂入り',
        description: '',
        history: ['無制限', '殿堂入り', 'プレミアム殿堂'],
        imageUrl: officialImage('dmrp10-s11'),
        officialUrl: officialPage('dmrp10-s11'),
      },
      {
        name: '《ジョット・ガン・ジョラゴン》',
        initial: '無制限 → 殿堂入り',
      ...
      },
      {
        ...
        description: '',
        history: ['無制限', '殿堂入り'],
        imageUrl: officialImage('dm30-030'),
        officialUrl: officialPage('dm30-030'),
      },
      {
        name: '《爆熱剣 バトライ刃》/《爆熱天守 バトライ閣》/《爆熱DX バトライ武神》と《超戦龍覇 モルトNEXT》',
        initial: 'プレミアム殿堂超次元コンビ → 無制限',
