...
alter table public.card_faces add column if not exists parser_version integer;
alter table public.card_faces add column if not exists content_hash text;
...
alter table public.face_import_runs add column if not exists parser_version integer;
alter table public.face_import_runs add column if not exists cache_kind text;
